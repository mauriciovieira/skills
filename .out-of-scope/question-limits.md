...
Grilling sessions inside these skills (e.g. `/triage`, `/improve-codebase-architecture`) do not enforce a maximum number of questions. Requests to add a configurable cap or hard ceiling are out of scope.
