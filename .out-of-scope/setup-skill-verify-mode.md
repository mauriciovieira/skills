# Verify/Check Mode for `setup-mauricio-vieira-skills`

This project will not add a dedicated verify/check mode (or a separate verify skill) for `setup-mauricio-vieira-skills`.
...
- #106 — Feature request: verify/check mode for setup-mauricio-vieira-skills
