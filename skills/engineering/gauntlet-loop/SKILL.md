...
> **Vendored from an external source.** This skill is copied verbatim (aside
> from this attribution block) from
> [`robonuggets/gauntlet-loop`](https://github.com/robonuggets/gauntlet-loop),
> file `.claude/skills/gauntlet-loop/SKILL.md`, commit
> [`9b1975a1b8f01981f3f1e6b667ad3aaf907178ea`](https://github.com/robonuggets/gauntlet-loop/commit/9b1975a1b8f01981f3f1e6b667ad3aaf907178ea)
> on branch `main`. Licensed under
> [CC-BY-4.0](https://creativecommons.org/licenses/by/4.0/). Attribution
> required by license; content kept intact below.
