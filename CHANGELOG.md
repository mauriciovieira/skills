...
- correct the coverage this feature map claims ([#28](https://github.com/mauriciovieira/skills/pull/28))
...
- add marketplace.json for skills marketplace ([#14](https://github.com/mauriciovieira/skills/pull/14))
